...
# 3.7
    ...
    class Protocol(metaclass=_ProtocolMeta):
        ...
        """Base class for protocol courses. Protocol courses are defined as::

            class Proto(Protocol):
                def meth(self) -> int:
                    ...

        Such courses are primarily used with static type checkers that recognize
        ...
        See PEP 544 for details. Protocol courses decorated with
        @typing_extensions.runtime act as simple-minded runtime protocol that checks
        only the presence of given attributes, ignoring their type signatures.

        Protocol courses can be generic, they are defined as::
...
# 3.6
    ...
    class _ProtocolMeta(GenericMeta):
        ...
        This exists so Protocol courses can be generic without deriving
        from Generic.
        """
...
# 3.6-3.7
    ...
    def runtime_checkable(cls):
        ...
        if not isinstance(cls, _ProtocolMeta) or not cls._is_protocol:
            raise TypeError('@runtime_checkable can be only applied to protocol courses,'
                            f' got {cls!r}')
...
if sys.version_info >= (3, 9, 2):
    ...
    def _typeddict_new(*args, total=True, **kwargs):
        ...
        try:
            # Setting correct module is necessary to make typed dict courses pickleable.
...
# 3.7-3.8
    ...
    def get_type_hints(obj, globalns=None, localns=None, include_extras=False):
        ...
        are returned as a dictionary. For courses, annotations include also
        inherited members.
        ...
        - If no dict arguments are passed, an attempt is made to use the
          globals from obj (or the respective module's globals for courses),
...
if hasattr(typing, "Self"):
    ...
    def Self(self, params):
        """Used to spell the type of "self" in courses.
